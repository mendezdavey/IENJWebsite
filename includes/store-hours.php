...
$hours = array(
    ...
    'wed' => array('00:00-00:00'),
    'thu' => array('00:00-00:00'),
    'fri' => array('19:00-21:00'),
    'sat' => array('00:00-00:00'),
    'sun' => array('10:00-21:00')
);
...
$open_now = "<strong class='open'>Si, tenemos servicio! Hoy las horas son de %open% hasta %closed%.</strong>";
$closed_now = "<strong class='open'>Si, Hoy tenemos servicio! En %day%, las horas son de %open% hasta %closed%.</strong>";
$closed_all_day = "<strong class='closed'>Disculpe, estamos cerrados el %day%.</strong>";
...
if($is_exception) {
	...
	$open_now = str_replace('%day%', $days[$day], $open_now);
	echo $open_now;
} else {
	...
	$closed_now = str_replace('%day%', $days[$day], $closed_now);
	echo $closed_now;
}
